...
export default function ProfileScreen({ route, navigation }) {
  ...
  const blockFetch = async (blocked) => {
    ...
    if (isBlocked) {
      alertMessage =
        "User is not blocked anymore : he can access the application again";
      type = 15;
    } else {
      alertMessage =
        "User has been blocked : he can't access the application anymore";
    }
            ...
            <View style={styles.body}>
              <ScrollView style={{ marginBottom: tabBarHeight * 2 }}>
                  ...
                  <View style={styles.events}>
                    <View style={[{ flexDirection: "row" }]}>
                      <Text style={styles.text_body}>
                        ...
                        {formatageDate(profileInfo.date_birth)}
                      </Text>
                    </View>
                    <View style={[{ flexDirection: "row" }]}>
                      <Text style={styles.text_body}>
                ...
                >
                  ...
                  >
                    <Text style={styles.text_report}>
                      Report {profileInfo.name} {profileInfo.surname}
                    </Text>
                  </TouchableOpacity>
                </View>
                <Text
                ...
                <View
                  style={[
                    ...
                    {
                      display:
                        userInfo.admin === 1 && isRported ? "flex" : "none",
                    },
                  ]}
                >
                  <TouchableOpacity
                  ...
                  >
                    ...
                    >
                      {" "}
                      Block {profileInfo.name} {profileInfo.surname}
                    </Text>
                    <Text
                      style={[
                        styles.text_report,
                    ...
                    >
                      {" "}
                      Unblock {profileInfo.name} {profileInfo.surname}
                    </Text>
                  </TouchableOpacity>
                </View>
                <View
                ...
                >
                  ...
                  <Dropdown
                    ...
                    placeholder={
                      reportType === null ? "Select a report type" : reportType
                    }
