            ...
            <View style={styles.body}>
              <ScrollView style={{ marginBottom: "40%" }}>
                ...
                <View style={styles.content_info_name}>
                  ...
                  <Text style={[styles.subtext_footer]}>{userInfo.mail}</Text>
                  <Text style={[styles.subtext_footer]}>{userInfo.phone}</Text>
                </View>
                  ...
                  <View style={styles.events}>
                    <View style={[{ flexDirection: "row" }]}>
                      <Text style={styles.text_body}>
                        ...
                        {formatageDate(userInfo.date_birth)}
                      </Text>
                    </View>
                    <View style={[{ flexDirection: "row" }]}>
                      <Text style={styles.text_body}>
                ...
                >
                  ...
                  >
                    <Text style={styles.text_report}>
                      Report {userInfo.name} {userInfo.surname}
                    </Text>
                  </TouchableOpacity>
                </View>
                <View
