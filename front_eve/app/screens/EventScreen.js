...
export default function EventScreen({ route, navigation }) {
  ...
  const [reviewedParticipation, setReviewedParticipation] =
    React.useState(null);
  ...
  const cancelFetch = async (participants) => {
    ...
    alertRedirection(
      "Your event has been canceled, participants have been warned"
    );
  };
  ...
  const reviewFetch = async (id) => {
    fetch("https://eve-back.herokuapp.com/addReview", {
      ...
      body: JSON.stringify({
        score: defaultRating,
        review: new_review,
        creator: infoEvent.user_is_creator,
        writer_id: userId,
        target_id: id,
        event_id: eventId,
      }),
      ...
      [
        {
          text: "Ok",
          onPress: () => {
            navigation.navigate("Home"), { state: "event update" };
          },
        },
      ],
      { cancelable: false }
  ...
  const fetchReport = async () => {
    ...
    fetch("https://eve-back.herokuapp.com/getAdminId")
      .then((response) => {
        return response.json();
      })
      .then(async (json) => {
    ...
    return (
      ...
      >
        <Text
          style={[
            styles.text_header,
            { borderColor: COLORS.lightBlue, fontWeight: "bold", padding: 10 },
          ]}
        >
  ...
  const generate_non_participant_page = () => {
    ...
    if (infoEvent.status_id == 1) {
          ...
          <TouchableOpacity
            ...
            style={[
              styles.button,
              {
                marginBottom: 20,
                display:
                  infoEvent.demand_id === 0 && !nbParticipant ? "flex" : "none",
              },
            ]}
            onPress={() => {
              demandParticipation();
      ...
      return generate_cancelled_event();
    }
  };
      ...
      return (
        <View>
          <View style={styles.events}>
            ...
            <AddressComponent
              city={infoEvent.zip_code + " " + infoEvent.city}
              address={infoEvent.street_number + " " + infoEvent.street}
              latitude={infoEvent.latitude}
              longitude={infoEvent.longitude}
        ...
        <View>
          ...
          >
            ...
            <TouchableOpacity
              ...
              style={styles.button}
              onPress={() => {
                reviewEvent(infoEvent.creator_id);
              }}
            >
        ...
        <View>
          ...
          >
            ...
            <TouchableOpacity
              ...
              style={styles.button}
              onPress={() =>
                console.log("navigate to edit event page on process")
              }
            >
        ...
        <View>
          ...
          <View
            style={[
              ...
              { display: reviewedParticipation != null ? "flex" : "none" },
            ]}
          >
            <Dropdown
              style={[
            ...
            >
              ...
              <TouchableOpacity
                ...
                style={[
                  styles.button,
                  { backgroundColor: COLORS.grey, marginLeft: 10 },
                ]}
                onPress={() => {
                  navigation.navigate("EditEventScreen", { eventId: eventId });
                }}
              >
                <Text style={[styles.text_button, { color: COLORS.white }]}>
                  Edit Event
        ...
        {isLoading ? (
          ...
          <View>
            ...
            <View style={styles.body}>
              <ScrollView style={{marginBottom: Dimensions.get("window").height*0.27}}>
                <View
                  style={[
                    styles.notif_buble,
                ...
                >
                  <View style={styles.container_categorie}>
                    ...
                    <Text style={styles.name_cat}>
                      {infoEvent.categorie_name}
                    </Text>
                  </View>
                ...
                <View style={styles.contentContainer}>
                  <View style={styles.info_event}>
                    <Image
                      ...
                      source={{ uri: infoEvent.event_image }}
                    />
                    <Text style={styles.title_info_event}>
                      {infoEvent.event_name}
                    </Text>
                    <Text style={styles.text_info_event}>
                      {formatageDate(infoEvent.date)}
                    </Text>
                    <Text style={styles.text_info_event}>
                      {infoEvent.place}
                    </Text>
                    ...
                    <Image
                      style={styles.profilImage}
                      source={{ uri: infoEvent.creator_image }}
                    />
                    <Text
                      style={[
                        styles.desc,
                        {
                          display:
                            infoEvent.description != null ? "flex" : "none",
                        },
                      ]}
                    >
                  ...
                  <View style={styles.otherInfos}>{bodyGen()}</View>
                  <TouchableOpacity
                    activeOpacity={0.7}
                    style={{
                      width: "100%",
                  ...
                  <View
                    style={[
                      styles.reportCause,
                      { display: causeVisible ? "flex" : "none" },
                    ]}
                  >
                    <Text style={styles.text_cause}>
                      Select a cause for the report
                    </Text>
                    <Dropdown
                      style={[
                        styles.dropdown,
