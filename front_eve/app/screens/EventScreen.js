...
export default function EventScreen({route, navigation}) {
  ...
  const participateFetch = async()=>{
    ...
    fetch("http://10.24.40.91:3000/demandParticipation",{
      method: "POST",
  ...
  const LikeFetch = async(like)=>{
    ...
    fetch("http://10.24.40.91:3000/setLiked",{
      method: "POST",
      headers: { "content-type": "application/json" },
  ...
  const cancelFetch = async(participants)=>{
    ...
    fetch("http://10.24.40.91:3000/cancelEvent",{
      method: "POST",
      headers: { "content-type": "application/json" },
  ...
  const withdrawFetch = async()=>{
    ...
    fetch("http://10.24.40.91:3000/removeParticipant",{
      method: "POST",
      headers: { "content-type": "application/json" },
      body: JSON.stringify({user_id:userId, event_id: eventId}),
    }).catch((error)=>console.error(error));
  ...
  const reviewFetch = async(id)=>{
    ...
    fetch("http://10.24.40.91/addReview",{
      method: "POST",
      headers: { "content-type": "application/json" },
  ...
  useEffect(() => {
    ...
    if(retreive){
      Promise.all([
        ...
        fetch('http://10.24.40.91:3000/getInfoEvent',{
          method: "POST",
          headers: {'content-type': 'application/json'},
          body: JSON.stringify({"event_id":eventId , "user_id": userId})
        }),
        fetch('http://10.24.40.91:3000/getReviewEvent',{
          method: "POST",
          headers: {'content-type': 'application/json'},
          body: JSON.stringify({
            "event_id":eventId,
          })}),
        fetch('http://10.24.40.91:3000/getEventParticipants',{
          method: "POST",
          headers: {'content-type': 'application/json'},
          body: JSON.stringify({"event_id": eventId})
        }),
        ...
        data.map((item,index)=>{
          ...
          if(index==0){
            ...
            fetch('http://10.24.40.91:3000/getReviewId',{
              method: "POST",
              headers: {'content-type': 'application/json'},
