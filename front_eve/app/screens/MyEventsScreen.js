  ...
  useEffect(() => {
    ...
    if (retreive) {
      Promise.all([
        ...
        fetch(API_URL + "/getUpcomingEvent", {
          method: "POST",
          headers: { "content-type": "application/json" },
          body: JSON.stringify({
            id: userId,
